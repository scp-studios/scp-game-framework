...
VertexBuffer::VertexBuffer(uint32_t p_size)
{
    glGenBuffers(1, &m_handle);
    glBindBuffer(GL_ARRAY_BUFFER, m_handle);
    glBufferData(GL_ARRAY_BUFFER, p_size, nullptr, GL_STATIC_DRAW);
...
VertexBuffer::VertexBuffer(VertexBuffer& src)
{
    ...
    glBufferData(GL_ARRAY_BUFFER, sourceBufferSize, nullptr, GL_STATIC_DRAW);
